...
export const UI_COPY = {
  en: {
    ...
    newsletters: {
      ...
      help: "You can use one address for every newsletter. Curioflow groups issues by authenticated sender and List-ID.",
  ...
  "zh-Hans": {
    ...
    newsletters: {
      ...
      help: "所有 Newsletter 共用一个地址。Curioflow 会根据已验证的发件人和 List-ID 自动分组。",
