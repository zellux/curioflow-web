...
export const UI_COPY = {
  en: {
    ...
    addSource: {
      ...
      description: "Everything you add is fetched, parsed into clean reading text, and indexed into your library. For OPML imports, newsletter delivery, and podcast subscriptions, use Settings → Import feeds.",
    ...
    item: {
      ...
      kind: { feed: "FEED", newsletter: "NEWSLETTER", pdf: "PDF", podcast: "PODCAST", url: "URL" },
    ...
    newsletters: {
      ...
      copied: "Copied",
      copy: "Copy",
      copyError: "Unable to copy the newsletter address. Select the address and copy it manually.",
      create: "Create my newsletter address",
      createError: "Unable to create your newsletter address",
      creating: "Creating address...",
      description: "Use this private address when subscribing to any newsletter. New issues will appear in Newsletters automatically.",
      loadError: "Unable to load your newsletter address",
      loading: "Loading newsletter inbox...",
      rename: "Rename",
      saveName: "Save",
    ...
    library: {
      ...
      emptyFeeds: "No articles from your RSS feeds yet.",
      emptyLibrary: "Save the first article to begin.",
      emptyNewsletters: "Subscribe with your Curioflow email address to receive your first newsletter.",
      emptyPodcasts: "Subscribe to a podcast to receive your first episode.",
      ...
      newsletterCopy: "Newsletters sent to your Curioflow address, grouped by sender. Save the issues worth keeping.",
      podcast: "Podcast",
      podcastCopy: "The latest episode from every podcast you follow. Save the ones worth keeping into your library.",
      rssFeeds: "RSS feeds",
    ...
    settings: {
      ...
      importFeedsIntro: "Bring subscriptions and delivery sources into Curioflow without crowding the quick Add source flow.",
      importOpml: "Import feeds from OPML",
      importOpmlIntro: "Bring in your whole subscription list at once. Export an OPML file from Feedly, Inoreader, NetNewsWire, Reeder, or another reader, then upload it here.",
      language: "Language",
      ...
      llmSavedContextError: "LLM settings saved, but context-window detection failed:",
      contextWindowDetected: (tokens: string) => `Detected context window: ${tokens} tokens`,
      contextWindowUnknown: "Context window has not been detected.",
      ...
      podcastSubscriptions: "Podcast subscriptions",
      podcastSubscriptionsIntro: "Subscribe with a podcast RSS URL. New episodes will appear in Podcasts.",
  ...
  "zh-Hans": {
    ...
    addSource: {
      ...
      close: "关闭添加来源对话框",
      description: "添加的内容会被抓取、解析为干净的阅读文本，并加入索引。OPML 导入、Newsletter 投递和播客订阅请前往“设置 → 导入订阅源”。",
    ...
    item: {
      ...
      kind: { feed: "订阅", newsletter: "NEWSLETTER", pdf: "PDF", podcast: "播客", url: "URL" },
      needsRetry: "需要重试",
    ...
    newsletters: {
      ...
      copied: "已复制",
      copy: "复制",
      copyError: "无法复制 Newsletter 地址，请选中地址并手动复制。",
      create: "创建我的 Newsletter 地址",
      createError: "无法创建 Newsletter 地址",
      creating: "正在创建地址...",
      description: "订阅任何 Newsletter 时使用这个私有地址，新一期内容会自动出现在 Newsletter 中。",
      loadError: "无法加载 Newsletter 地址",
      loading: "正在加载 Newsletter 收件箱...",
      rename: "重命名",
      saveName: "保存",
    ...
    library: {
      ...
      emptyFeeds: "RSS 订阅源还没有文章。",
      emptyLibrary: "先保存第一篇文章吧。",
      emptyNewsletters: "使用你的 Curioflow 邮箱订阅后，Newsletter 会显示在这里。",
      emptyPodcasts: "订阅播客后，最新单集会显示在这里。",
      ...
      newsletterCopy: "发送到 Curioflow 地址的 Newsletter 会按发件人分组。值得保留的内容可以保存到资料库。",
      podcast: "播客",
      podcastCopy: "你关注的所有播客中的最新单集。值得保留的内容可以保存到资料库。",
      rssFeeds: "RSS 订阅源",
    ...
    settings: {
      ...
      importFeeds: "导入订阅源",
      importFeedsIntro: "在设置中管理批量订阅和投递来源，让“添加来源”保持简洁。",
      importOpml: "从 OPML 导入订阅源",
      importOpmlIntro: "一次导入完整订阅列表。先从 Feedly、Inoreader、NetNewsWire、Reeder 或其他阅读器导出 OPML 文件，再在这里上传。",
      language: "语言",
      ...
      llmSaved: "LLM 设置已保存。",
      llmSavedContextError: "LLM 设置已保存，但 context window 探测失败：",
      contextWindowDetected: (tokens: string) => `已探测到 context window：${tokens} tokens`,
      contextWindowUnknown: "尚未探测 context window。",
      ...
      podcastSubscriptions: "播客订阅",
      podcastSubscriptionsIntro: "使用播客 RSS 地址订阅，新单集会显示在“播客”中。",
