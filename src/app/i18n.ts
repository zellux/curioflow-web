...
export const UI_COPY = {
  en: {
    ...
    settings: {
      ...
      languageModelIntro: "Choose separate models for summaries and Ask. The provider, API key, and base URL are shared and stored locally on this device.",
  ...
  "zh-Hans": {
    ...
    settings: {
      ...
      languageModel: "语言模型",
      languageModelIntro: "为摘要和 Ask 分别选择模型。Provider、API 密钥和 Base URL 由两者共享，并只保存在这台设备上。",
      llmSaved: "LLM 设置已保存。",
