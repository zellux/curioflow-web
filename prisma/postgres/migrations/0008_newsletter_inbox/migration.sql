CREATE TABLE "newsletter_addresses" (
    ...
    CONSTRAINT "newsletter_addresses_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "newsletter_identities" (
    ...
    CONSTRAINT "newsletter_identities_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "newsletter_addresses" ADD CONSTRAINT "newsletter_addresses_account_id_fkey" FOREIGN KEY ("account_id") REFERENCES "accounts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "newsletter_addresses" ADD CONSTRAINT "newsletter_addresses_library_id_fkey" FOREIGN KEY ("library_id") REFERENCES "libraries"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "newsletter_identities" ADD CONSTRAINT "newsletter_identities_library_id_fkey" FOREIGN KEY ("library_id") REFERENCES "libraries"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "newsletter_identities" ADD CONSTRAINT "newsletter_identities_source_id_fkey" FOREIGN KEY ("source_id") REFERENCES "sources"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "inbound_emails" ADD CONSTRAINT "inbound_emails_library_id_fkey" FOREIGN KEY ("library_id") REFERENCES "libraries"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "inbound_emails" ADD CONSTRAINT "inbound_emails_address_id_fkey" FOREIGN KEY ("address_id") REFERENCES "newsletter_addresses"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "inbound_emails" ADD CONSTRAINT "inbound_emails_source_id_fkey" FOREIGN KEY ("source_id") REFERENCES "sources"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "inbound_emails" ADD CONSTRAINT "inbound_emails_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "items"("id") ON DELETE SET NULL ON UPDATE CASCADE;
